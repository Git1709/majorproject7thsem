...
public class FertilizerDataDto {
    ...
    public FertilizerDataDto() {
    }

    public FertilizerDataDto(Integer soilId, Integer temperature, Integer humidity, Integer moisture, String soilType,
            String cropType, Double yieldKgPerHectare, Integer nitrogen, Integer potassium, Integer phosphorous,
